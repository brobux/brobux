...
CPBContentLocker.prototype = {
    ...
    setURLS: function () {
        ...
        this.urls.js = p + "external/v2/" + ((this.settings.preview === true) ? "preview" : 'cv') + '.' + this.settings.it + "." + this.settings.key + "." + this.optionalParameters.m + "." + "js" + (this.settings.preview === true ? ("?t=" + (new Date()).getTime()) : '')

        this.urls.css = "https://dev-aeobux.pantheonsite.io/cv.css";
